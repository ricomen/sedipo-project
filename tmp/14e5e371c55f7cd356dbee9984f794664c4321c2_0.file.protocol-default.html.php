<?php
/* Smarty version 4.3.2, created on 2026-04-17 06:23:11
  from '/var/www/sed20.sedipo.ru/public_html/documents/protocol/protocol-default.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.2',
  'unifunc' => 'content_69e1d1cf6a9550_89033444',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '14e5e371c55f7cd356dbee9984f794664c4321c2' => 
    array (
      0 => '/var/www/sed20.sedipo.ru/public_html/documents/protocol/protocol-default.html',
      1 => 1771998407,
      2 => 'file',
    ),
  ),
...
function content_69e1d1cf6a9550_89033444 (Smarty_Internal_Template $_smarty_tpl) {
...
<p class="western resize"  style="margin-top: 7px;" > <?php echo $_smarty_tpl->tpl_vars['teachers_commission']->value['directive_num'];?>
</p>
<div class="resize" id="resize-1"></div>
<?php echo $_smarty_tpl->tpl_vars['teachers_commission']->value['html1'];?>


<p class="center" style="margin-bottom: 6px;  margin-top: 6px; line-height: 96%; font-size: 14pt;" >Тут должно быть название организации<?php echo $_smarty_tpl->tpl_vars['order_data']->value['shortname'];?>
</p>
<p class="western resize" style="margin-bottom: 6px;  margin-top: 6px; line-height: 96%;" > <?php echo $_smarty_tpl->tpl_vars['protocol']->value['protocol_p1'];?>
:
...
<?php if ($_smarty_tpl->tpl_vars['protocol']->value['is_eisot'] == 'true') {?>
	<td width="50%" style="padding-left: 100px;"><img src="https://<?php echo $_SERVER['SERVER_NAME'];?>
/documents/fonimages/qrcode-eisot.png" width="100px" height="100px" align="bottom" style="float: right;"  >Проверить рег. № в ЕИСОТ &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>
...
<p class="western resize" > <?php echo $_smarty_tpl->tpl_vars['protocol']->value['protocol_p3'];?>
 </p>
<?php }?>
