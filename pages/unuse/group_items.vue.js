var GroupItems = {
    ...
    if(this.cohort_id>0) { 
       	    axios
    		    ...
    		    .then(response5 => { 
		             ...
		             this.counterparty_name = this.info5.result.counterparty_name
  ...
  methods: {
	...
	template: `<div><navigation></navigation><h3>Список группы {{name}}</h3> 
 ...
 <div class="row justify-content-between">
  ...
  <div align="right">
    <router-link  :to="{ name: 'groups_list', params: {orderid: this.a_order_id}}" ><button  class="btn btn-outline-primary"> Закрыть </button></router-link>
  </div>
