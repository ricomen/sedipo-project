...
/*        axios
    ...
    load_combo_egrul(){
      ...
      if(this.counterparty_с!=''){
       axios
        ...
        .post(JsonApiURL+'api/egrul_json.php', {list: { search: this.inn, sessionId: session_t.sessionId }})
        .then(response => { 
              this.info3 = response.data
              this.wait = 0
              console.log(response)
    ...
    load_combo_names(){
      ...
      if(this.name!=''){
       axios
        //.post(JsonApiURL+'api/egrul_json.php', {list: {conditions: {"type": 0}, search: this.name, sessionId: session_t.sessionId }})
        .post(JsonApiURL+'api/egrul_json.php', {list: { search: this.name, sessionId: session_t.sessionId }})
        .then(response => { 
    ...
    load_egrul(){
      axios
      .post(JsonApiURL+'api/egrul_json.php', {object: {objectId: this.inn, sessionId: session_t.sessionId } })
      .then(response => { 
            this.info9 = response.data
