...
//  { path: '/counterparty_edit/:counterpartyid/:make?', name: 'counterparty_edit', component: CounterpartyEdit, props: true },
...
//  { path: '/docs_howto', name:'docs_howto', component: DocsHowto },
