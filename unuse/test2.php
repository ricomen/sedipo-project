<?php
	...
	require_once "file-explorer/file_explorer_fs_helper.php";

	$options = array(
		"base_url" => "https://sed.ipo5.ru/files/",
		"protect_depth" => 1,  // Protects base directory + additional directory depth.
		"recycle_to" => "Recycle Bin",
		"temp_dir" => "file-explorer-tmp",
		"dot_folders" => true,  // .git, .svn, .DS_Store
		"allowed_exts" => ".jpg, .jpeg, .png, .gif, .svg, .txt",
		"allow_empty_ext" => true,
		"thumbs_dir" => "thumbs",
		"thumbs_url" => "https://sed.ipo5.ru/thumbs/",
		"thumb_create_url" => "https://sed.ipo5.ru/test2.php/?action=file_explorer_thumbnail&xsrftoken=qwerasdf",
		"refresh" => true,
		"rename" => true,
		"file_info" => false,
		"load_file" => false,
	...
	FileExplorerFSHelper::HandleActions("action", "file_explorer_", "files", $options);
?>
